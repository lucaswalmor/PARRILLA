    ...
    methods: {
      ...
      salvarPedidoDB() {
        ...
        const data = {
            ...
            rua: this.dadosPedido.endereco.logradouro,
        ...
        if(this.forma_pagamento == '') {
          ...
          if (this.dadosPedido.troco != ''
            ...
            this.pedido_wpp = 
                  ...
                  '%0A' +
                  '%0A*Forma de pagamento:* ' + this.arrFormaPagamento +
                  '%0A' +
                  '%0A*--------------* ' +
                  '%0A' +
                  '%0A*Endereço de entrega* ' +
                  '%0A' +
                  '%0A*Rua:* ' + this.dadosPedido.endereco.logradouro + ' Nº ' + this.dadosPedido.numero +
                  '%0A' +
